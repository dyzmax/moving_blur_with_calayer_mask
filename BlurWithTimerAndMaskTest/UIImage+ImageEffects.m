...
- (UIImage *)applyLightEffectToRegion: (CGRect)cropRect
{
    ...
    return [self applyBlurWithRadius:8 tintColor:tintColor saturationDeltaFactor:1.8 maskImage:nil applyRegion:cropRect];
}
...
{
    UIColor *tintColor = [UIColor colorWithWhite:0.8 alpha:0.6];
